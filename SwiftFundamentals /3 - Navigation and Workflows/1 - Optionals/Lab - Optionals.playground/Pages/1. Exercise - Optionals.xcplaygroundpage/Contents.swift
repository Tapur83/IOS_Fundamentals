...
print("when we are changing string to int sometimes it cannot change the value as string could have alphabatecal letters. So we need to use int? to declare that if Int cannot be conveted it could set as nil")
/*:
