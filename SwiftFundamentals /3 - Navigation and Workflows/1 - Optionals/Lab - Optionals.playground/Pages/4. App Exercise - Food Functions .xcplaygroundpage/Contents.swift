...
func foodTime (for mealName: String ) -> Meal?{
    return meals[mealName]
}


if let breakfast = foodTime (for: "Breakfast"){
    print("Your meal is \(breakfast.food) and the calories it has is \(breakfast.calories)")
}else{
    print("You have not logged any")
}

if let lunch = foodTime (for: "Lunch"){
    print("Your meal is \(lunch.food) and the calories it has is \(lunch.calories)")
}else{
    print("You have not logged any")
}
/*:
