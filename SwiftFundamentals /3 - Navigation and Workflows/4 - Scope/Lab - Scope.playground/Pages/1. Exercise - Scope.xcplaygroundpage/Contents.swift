...
print("because it is not in the scope")
...
print("because the lobal initialised var 'x' is in scope")
...
var greet1 = greeting(greeting: "Hi there", name: "sara")
var greet2 = greeting(greeting: nil, name: "sara")
