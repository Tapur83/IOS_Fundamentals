...
//print(falcon.weapon)
print("It didn't work because destroyer was the inherited class of fighter so it can acces the values of the parent class but the parent class can not accces the properties of subclass. ")
