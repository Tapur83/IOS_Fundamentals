...
if let oldValue = dictionary.updateValue(31, forKey: "January"){
    print("Jan's old value: \(oldValue)")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["triangle", " Circle", "Square"]
var colorsArray = ["red", "yellow", "blue"]

var computedArray: [String:[String]] = [
    "shapes": shapesArray,
    "colors": colorsArray
]
...
if let colors = computedArray["colors"]{
    if let elementLast = colors.last{
        print("last color: \(elementLast)")
    }
}
