...
var checkArea = Rectangle(width: 10, height: 20)
print(checkArea.area)
...
struct Height {
    var heightInInches: Double{
        willSet {
            if newValue != heightInInches*2.54 {
                self.heightInCentimeters = newValue*2.54
            }
        }
        didSet {
            if heightInInches != heightInInches*2.54 {
    ...
    var heightInCentimeters: Double{
        willSet{
            if newValue != heightInCentimeters/2.54 {
                self.heightInInches = newValue/2.54
            }
        }
        didSet{
            if heightInCentimeters != heightInCentimeters/2.54 {
