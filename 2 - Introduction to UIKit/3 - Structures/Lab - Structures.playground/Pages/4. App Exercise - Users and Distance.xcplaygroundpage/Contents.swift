...
var User1 = User(name: "Tapur", age: 20, height: 5.4, weight: 60, activityLevel: 7);
print("Hello, my name is \(User1.name), I am \(User1.age) years old, I am \(User1.height) feet tall and I weigh \(User1.weight) kilograms.");
