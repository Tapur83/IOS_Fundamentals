...
var favouriteBook = Book(title: "AtomicHabits", author: "James Clear", pages:400, price: 500.5)
...
let laptop1 = Laptop(yearPurchase: 2020)
let laptop2 = Laptop( screenSize: 15, repairCount: 2, yearPurchase: 2019)
...
print(someonesHeight.heightInCentimeter)
...
var myHeight = Height(heightInCentimeter: 160)
print(myHeight.heightInCentimeter)
