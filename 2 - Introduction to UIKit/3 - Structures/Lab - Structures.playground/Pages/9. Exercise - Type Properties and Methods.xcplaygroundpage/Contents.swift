...
struct User {
    ...
    static var currentUser = User(userName: "Tapur Aggarwal", email:      "aggarwaltapur@example.com", age: 20)  //instance
 ...
 */
var newUser = User(userName: "John Doe", email: "johndoe@example.com", age: 30)
