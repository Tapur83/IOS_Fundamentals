...
class SelectRoomTypeTVC: UITableViewController {
    ...
    weak var delegate: SelectRoomTypeTVCD?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let roomType:RoomType = RoomType.all[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.selectRoomTypeTVC(self, didSelect: roomType)
        tableView.reloadData()
    }

    protocol SelectRoomTypeTVCD: AnyObject{
