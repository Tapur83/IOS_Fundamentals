...
//
//  Created by Tapur Aggarwal on 26/08/25.
//
...
class AddEditTableViewController: UITableViewController {
    ...
    func updateSaveButtonState(){
        ...
        saveButton.isEnabled = containSingleEmoji(symbolTextField) &&
    ...
    func containSingleEmoji(_ textDield: UITextField) -> Bool{
        guard let text = symbolTextField.text, text.count == 1 else{
            return false
        }
